...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lazypredict-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13700&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lazypredict-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lazypredict` can be installed with:

```
conda install lazypredict
```

It is possible to list all of the versions of `lazypredict` available on your platform with:
